...
import { deleteUsername } from "../../storage/user.js";
import { UserAvatar } from "../app/UserAvatar.jsx";
      ...
      <Toolbar sx={{ ...navbar_style.toolbar }} style={{ padding: 0 }}>
        <Box sx={{ ...navbar_style.toolbar_container }}>
          ...
          <Box sx={{ ...navbar_style.login }}>
            ...
            >
              <UserAvatar sx={{ ...navbar_style.avatar }}></UserAvatar>
            </IconButton>
            ...
            >
              <Typography sx={{ fontSize: 17, color: "#4326a1" }}>
                Salir
              </Typography>
